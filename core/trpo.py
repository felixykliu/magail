...
def trpo_step(policy_net, value_net, optimizer_value, optim_value_iternum, states, actions, \
    returns, advantages, fixed_log_probs, max_kl, damping, l2_reg, use_fim=True, p_i=1):
